        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="nama_rombel" value="<?php echo $rombel['nama_rombel'] ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php
                    echo cmb_dinamis('kelas', 'tbl_kelas', 'nama_kelas', 'kd_kelas', $rombel['kelas']);
                    ?>
                </div>
            </div>
        </div>
