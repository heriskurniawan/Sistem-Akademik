<div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Delete Confiermation</h3>
          ...
          <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                     <input class="form-control" type="text" name="nama" readonly="true" value="<?php echo $siswa['nama'] ?>" placeholder="INPUT NAMA LENGKAP">
                </div>
             </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-4">
                  ...
                  <?php echo anchor('siswa/delete/'.$siswa['nim'],'<button class="btn btn-danger">DELETE</button>',"title='Delete'");?>
                    <a href="<?php echo base_url()?>" name="batal" class="btn btn-info">BATAL</a>
                </div>
                </form>
