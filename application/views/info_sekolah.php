        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="nama_sekolah" value="<?php echo $info['nama_sekolah']; ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="alamat_sekolah" value="<?php echo $info['alamat_sekolah']; ?>">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="email" value="<?php echo $info['email'] ?>">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="telpon" value="<?php echo $info['telpon'] ?>">
                </div>
            </div>
        </div>
        <div class="row">
