    ...
    function data() {
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    //return "<a href='edit.php?id=$d'>EDIT</a>";
                    return anchor('guru/edit/'.$d,'<i class="fa fa-edit"></i>','class="btn btn-sm btn-info" data-placement="top" data-original-title="Edit"').' &nbsp; &nbsp;
                        '.anchor('guru/delete/'.$d,'<i class="fa fa-trash"></i>','class="btn btn-sm btn-danger tooltips" data-original-title="Delete"');
                }
            )
        );
