...
Class Rombel extends CI_Controller {
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    ...
                    return anchor('rombel/edit/'.$d,'<i class="fa fa-edit"></i>','class="btn btn-sm btn-info tooltips" data-placement="top" data-original-title="Edit"').' 
                        '.anchor('rombel/delete/'.$d,'<i class="fa fa-trash"></i>','class="btn btn-sm btn-danger tooltips" data-placement="top" data-original-title="Delete"');
                }
            )
        );
    ...
    function show_combobox_rombel_by_rombel(){
        
      //  $jurusan = $_GET['jurusan'];
        echo "<select name='rombel' id='rombel' class='form-control'>";
