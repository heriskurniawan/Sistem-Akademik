        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    ...
                    return anchor('users/edit/'.$d,'<i class="fa fa-edit"></i>','class="btn btn-sm btn-info tooltips" data-placement="top" data-original-title="Edit"').' 
                        '.anchor('users/delete/'.$d,'<i class="fa fa-trash"></i>','class="btn btn-sm btn-danger tooltips" data-placement="top" data-original-title="Delete"');
                }
            )
        );
