...
Class Jurusan extends CI_Controller {
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    ...
                    return anchor('jurusan/edit/'.$d,'<i class="fa fa-edit"></i>','class="btn btn-sm btn-info tooltips" data-placement="top" data-original-title="Edit"').' 
                        '.anchor('jurusan/delete/'.$d,'<i class="fa fa-trash"></i>','class="btn btn-sm btn-danger tooltips" data-placement="top" data-original-title="Delete"');
                }
            )
        );
    ...
    function show_combobox_rombel_by_jurusan(){
        ...
        //  $jurusan = $_GET['jurusan'];
          echo "<select name='jurusan' id='jurusan2' class='form-control' onchange='loadSiswa()'>";
         // $this->db->where('kd_jurusan',$jurusan);
          $jurusan = $this->db->get('tbl_jurusan');
